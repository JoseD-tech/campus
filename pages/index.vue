        ...
        <div class="h-full row-span-2">
          ...
          <BaseModal :modalActive="plataformasVirtuales" @close-modal="toggleModal('plataformasVirtuales')">
            <div class="text-black">
              ...
              <nuxt-link :to="enlaces.plataformaVarinas[4].url" target="_blank"
        ...
        <div class="h-full row-span-2">
          ...
          <BaseModal :modalActive="produccionAcademica" @close-modal="toggleModal('produccionAcademica')">
            <div class="text-black">
              ...
              <nuxt-link :to="enlaces.produccionCreacion[0].url" target="_blank"
                class="block text-center py-4 mt-4 font-semibold bg-green-700 px-4 rounded-md cursor-pointer text-white border hover:bg-white hover:border-green-700 hover:text-green-700 ease-in-out duration-300">{{
                  enlaces.produccionCreacion[0].titulo }}</nuxt-link>

              <nuxt-link :to="enlaces.produccionCreacion[3].url" target="_blank"
          ...
          <BaseModal :modalActive="formacionCapacitacion" @close-modal="toggleModal('formacionCapacitacion')">
            <div class="text-black">
              ...
              <nuxt-link :to="enlaces.formacionCapacitacion[0].url" target="_blank"
                class="block text-center py-4 mt-4 font-semibold bg-red-700 px-4 rounded-md cursor-pointer text-white border hover:bg-white hover:border-red-700 hover:text-red-700 ease-in-out duration-300">{{
                  enlaces.formacionCapacitacion[0].titulo }}</nuxt-link>
              <nuxt-link :to="enlaces.formacionCapacitacion[1].url" target="_blank"
                class="block text-center py-4 mt-4 font-semibold bg-blue-700 px-4 rounded-md cursor-pointer text-white border hover:bg-white hover:border-blue-700 hover:text-blue-700 ease-in-out duration-300">{{
                  enlaces.formacionCapacitacion[1].titulo }}</nuxt-link>
              <nuxt-link :to="enlaces.formacionCapacitacion[2].url" target="_blank"
                class="block text-center uppercase py-4 mt-4 font-semibold bg-green-700 px-4 rounded-md cursor-pointer text-white border hover:bg-white hover:border-green-700 hover:text-green-700 ease-in-out duration-300">{{
                  enlaces.formacionCapacitacion[2].titulo }}</nuxt-link>
            </div>
          </BaseModal>
        </div>

...
<template>
  <div class="md:h-screen md:flex md:items-center md:justify-center fondo">
    <div class="bg-white p-10 border rounded-xl shadow-md shadow-gray-500/20 md:w-2/3">
      <img class="w-24 h-24 rounded-full mx-auto bg-center bg-cover mb-10 md:-mt-6" src="/logo-unellez.jpg"
        alt="logo unellez" />
      <h1 class="text-4xl uppercase font-light mb-10 text-center">Campus Virtual</h1>
      ...
      <div class="md:grid md:grid-cols-3 grid-rows-4 gap-4">
        ...
        <div class="h-full row-span-2">
          <button type="button" class="block bg-red-600 w-full h-full text-white font-medium uppercase rounded-md py-4 px-4 mb-4"
